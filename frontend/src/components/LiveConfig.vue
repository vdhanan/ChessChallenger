  ...
  <div class="container">
    ...
    <b-list-group>
      <div v-for="(challenger, position) in queue" :key=position>
        <b-list-group-item v-bind:href="'https://www.chess.com/live?#ch=' + challenger[1]" target="_blank" style="background: #6441A4;">
    ...
    <div>
      <b-form-checkbox v-model="acceptingChallenges" @change="updateActive" switch>
        <div v-if="acceptingChallenges">
          <b style="color: #e5e3e8"> Accepting Challenges</b>
        </div>
        <div v-if="!acceptingChallenges">
          <b> Not Accepting Challenges</b>
        </div>
      </b-form-checkbox>
    </div>
    <div>
